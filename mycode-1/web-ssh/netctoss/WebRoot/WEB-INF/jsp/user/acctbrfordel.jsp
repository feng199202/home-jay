...
<body>
	<center>
		...
		<form name="pageForm" method="post"
			action="${pageContext.request.contextPath}/manageUser/manageUserAction!acctbrForDel0">
								...
								<s:if test="users!=null&&users.size()>0">
									...
									<s:iterator value="users" status="statu">
										...
										<tr>
											...
											<td><a
												href="${pageContext.request.contextPath}/manageUser/manageUserAction!acctbrDoDel?user.userId=<s:property value="userId" />"
												onclick="return window.confirm('确认要删除吗?')"><img
													src="${pageContext.request.contextPath}/images/cross.png" />
											</a></td>
										</tr>
									</s:iterator>
							</table>
