		...
		<table width='100%' border='0' cellspacing='0' cellpadding='0'>
			<tr width="100%" height="10%">
				...
				<td align="left" height='31'
					...
					<s:form name="addForm" 
						action="manageUserAction!bussForUp0" namespace="/manageUser">
						查询条件： 用户名称:
			...
			<tr bgcolor="#03F" style="color:white" >	<td>业务ID</td>
								<td>用户名</td>
								<td>业务登录名</td>
								<td>状态</td>
								<td>实验室IP</td>
						...
						<s:if test="userServices!=null&&userServices.size()>0">
							...
							<tr>
								...
								<td><s:property value="user.accountName" /></td>
								<td><s:property value="loginName" /></td>
								<td>
								<s:if test="serviceStatus==1">开通</s:if>
								<s:if test="serviceStatus==2">暂停</s:if>
								<s:if test="serviceStatus==0">无</s:if>
								</td>
								<td><s:property value="labIp" /></td>
								<td><s:property value="pricing.pricingName" /></td>
									<td>
							<a href="${pageContext.request.contextPath}/manageUser/manageUserAction!bussToUp?serviceIdBean=<s:property value="serviceId" />"><img src="../images/pencil.png" alt="Edit"/></a>
						</td>
