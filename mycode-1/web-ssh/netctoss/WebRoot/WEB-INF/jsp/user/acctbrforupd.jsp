...
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="pageForm" method="post"
						action="${pageContext.request.contextPath}/manageUser/manageUserAction!acctbrForUpd0">
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<tr bgcolor="#03F" style="color:white" ><td>用户名</td><td>登录名</td><td>状态</td><td>支付方式</td><td>电话</td><td>电子邮件</td><td>性别</td><td>修改操作</td>
				</tr></table>
				...
				<s:if test="users!=null&&users.size()>0">
					...
					<s:iterator value="users"  status="statu">
							...
							<tr>
								...
								<td>
								<s:if test="accountStatus==1">开通</s:if>
								<s:if test="accountStatus==2">暂停</s:if>
								<s:if test="accountStatus==0">无</s:if>
								</td>
								<td>
								...
								<td>
								<s:if test="gender==0">女</s:if>
								<s:if test="gender==1">男</s:if>
								</td>
							
						<td>
							<a href="${pageContext.request.contextPath}/manageUser/manageUserAction!toUpdateAcct?user.userId=<s:property value="userId" />"><img src="../images/pencil.png" alt="Edit"/></a>
						</td>
					</tr>
					</s:iterator>
