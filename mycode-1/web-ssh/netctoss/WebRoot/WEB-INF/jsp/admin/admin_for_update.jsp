				...
				<tr width="100%" height="10%">
					...
					<td align="left" height='31'
						...
						查询条件：&nbsp;&nbsp; 姓名:<s:textfield type="text"
							...
							style="width:70px" onfocus="HS_setDate(this)"
							name="endDateString" /> <input type="submit" value=" 查询" />
					</td>
				</tr>
				<tr width="100%">
							...
							<s:iterator value="admins" var="existAdmin">
								<s:if test="role.roleId !=1">
									<tr>
										...
										<td><a
											href="${pageContext.request.contextPath}/admin/manageAdminAction!toChangeAdmin?admin.adminId=<s:property value="adminId"/>"><img src="../images/pencil.png" alt="Edit"/></a>
										</td>
									</tr>
								</s:if>
							</s:iterator>
