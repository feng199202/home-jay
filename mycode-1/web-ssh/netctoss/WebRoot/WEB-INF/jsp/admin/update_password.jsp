		...
		<table width='100%' border='0' cellspacing='0' cellpadding='0'>
			<tr width="100%" height="300px">
				...
				<td align="center" valign="top"><s:form name="updatePwd"
						namespace="/admin" action="manageAdminAction!doUpdatePassword">
						<table border="0" cellspacing='0' cellpadding='0' width="80%"
							...
							<tr>
								...
								<td><input type="hidden" id="oldpassword"
									value="<s:property value="#session.loginedAdmin.password"/>" />
								</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							...
							<tr>
								...
								<td align="left"><s:password id="inputOld"></s:password></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
							...
							<tr>
								...
								<td align="left"><s:password name="admin.password"
										id="password1"></s:password></td>
							</tr>
							...
							<tr>
								...
								<td><input type="button" onclick="checkPassword();"
									value="确认更新密码" /> <input type="reset" value="重置" /></td>
							</tr>
						</table>
					</s:form>
				</td>
