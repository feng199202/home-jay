		...
		<table width='100%' border='0' cellspacing='0' cellpadding='0'>
			<tr width="100%" height="300px">
				...
				<td align="center" valign="top"><s:form name="addForm" id="addForm"
						action="manageAdminAction!addAdmin" namespace="/admin">
						<table border="0" cellspacing='0' cellpadding='0' width="80%"
							...
							<tr>
								...
								<td align="left"><input type="text" id="a1" name="admin.realName"
									value="" style="WIDTH:170px" />*
									<span id="error1">名称不能为空</span></td>
							</tr>
							<tr>
								<td align="right">帐号名：</td>
								<td align="left"><input type="text" id="a2"
									name="admin.accountName" value="" style="WIDTH:170px" />*
									<span id="error2">名称不能为空</span></td>
							</tr>
							<tr>
								<td align="right">口令：</td>
								<td align="left"><input type="text" id="a3" name="admin.password"
									value="" style="WIDTH:170px" />*
									<span id="error3">此处不能为空</span></td>
							</tr>
							<tr>
								<td align="right">确认口令：</td>
								<td align="left"><input id="a4" type="text" name="password"
									value="" style="WIDTH:170px" />*
									<span id="error4">密码输入不一样</span></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left"><input type="text" name="admin.adminPhone"
									value="" style="WIDTH:170px" /></td>
							</tr>
							<tr>
								<td align="right">选择角色：*</td>
								<td align="left">
									<div
										style="display:block;overflow-y:scroll;overflow-x:auto;height:120px;width:200px;background-color:#eeeeee;">
