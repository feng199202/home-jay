						...
						<tr>
							...
							<td height='31' background='../images/ctitle_bak_fcenter.jpg'>
								...
								src="../images/sy_2_18.jpg" border="0"> <a
									href='../admin/adminupdate.htm' class=channel_title>信息修改</a>
							</td>
						</tr>
					</table>
				</td>
						...
						<table border="0" cellspacing='0' cellpadding='0' width="80%"
							...
							<tr>
								...
								<td align="left"><input type="text" name="loginname"
									value="admin" style="WIDTH:170px">
								</td>
							</tr>
							<tr>
								<td align="right">口令：</td>
								<td align="left"><input type="text" name="loginpassword"
									value="admin" style="WIDTH:170px">
								</td>
							</tr>
							<tr>
								<td align="right">确认口令：</td>
								<td align="left"><input type="text" name="passwordsec"
									value="admin" style="WIDTH:170px">
								</td>
							</tr>
							<tr>
								...
								<td align="left"><input type="text" name="email"
									value="jiaqiang@tarena.com.cn" style="WIDTH:170px">
								</td>
							</tr>
							<tr>
								<td align="right">电话：</td>
								<td align="left"><input type="text" name="phone"
									value="15801664915" style="WIDTH:170px" /></td>
							</tr>
