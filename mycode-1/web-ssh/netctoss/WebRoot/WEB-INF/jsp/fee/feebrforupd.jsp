...
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<s:form name="addForm"  action="magePricingAction!feeForUp0" namespace="/pricing">
			查询条件：&nbsp;&nbsp;
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<td>资费名称</td><td>基费</td><td>月租费用</td><td>资费说明</td><td>&nbsp;</td></tr></table>
			<table cellspacing='0' cellpadding='0' width="100%"  border="0" class="cssraindemo1">
				<s:if test="pricings!=null&&pricings.size()>0">
					...
					<s:iterator value="pricings"  status="statu">
							...
							<td>
							<a href="${pageContext.request.contextPath}/pricing/magePricingAction!feeToUp?pricingId1=<s:property value="pricingId" />"><img src="../images/pencil.png" alt="Edit"/></a>
						</td>
