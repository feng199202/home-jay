		...
		<table width='100%' border='0' cellspacing='0' cellpadding='0'>
			<tr width="100%" height="300px">
				...
				<td align="center" valign="top"><s:form name="addForm"
						action="magePricingAction!feeDoUp" namespace="/pricing">
						<table border="0" cellspacing='0' cellpadding='0' width="50%"
							...
							<tr>
								...
								<td align="left" valign="top"><input type="text" id="a1"
									...
									value="<s:property value="pricing.pricingName"/>"
									style="WIDTH:170px" />* <span id="error1">资费名称不能为空</span>
								</td>
							</tr>
							<tr>
								<td colspan="2" align="center"></td>
							...
							<tr>
								...
								<td align="left" valign="top"><input type="text" id="a2"
									name="pricing.baseFee"
									value="<s:property value="pricing.baseFee"/>"
									style="WIDTH:170px">* <span id="error2">请填写数字</span>
								</td>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left" valign="top"><input type="text" id="a3"
									name="pricing.rateFee"
									value="<s:property value='pricing.rateFee'/>"
									style="WIDTH:170px">* <span id="error3">请填写数字</span>
								</td>
								</td>
							</tr>

							<tr>
								<td align="right" valign="top">资费描述：</td>pricing.description
								<td align="left" valign="top"><textarea type="text"
										name="pricing.description">
										<s:property value="pricing.description" />
									</textarea>
								</td>
							</tr>
							<tr>
