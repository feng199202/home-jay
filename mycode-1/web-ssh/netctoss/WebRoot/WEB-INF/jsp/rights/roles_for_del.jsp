				...
				<tr width="100%" height="10%">
					...
					<td align="left" height='31'
						...
						查询条件：&nbsp;&nbsp; 角色名称:<s:textfield type="text"
							name="role.roleName" style="WIDTH:100px" /> <input type="submit"
						value=" 查询" />
					</td>
				</tr>
							...
							<table cellspacing='0' cellpadding='0' width="100%" border="0"
								...
								<s:iterator value="roles" status="status">
									<tr>
										...
										<td><a
											onclick="return window.confirm('确认要删除该角色吗?删除该角色会使拥有该角色的管理员也删除!!')"
											href="${pageContext.request.contextPath}/admin/manageRoleRightAction!deleteRole?role.roleId=<s:property value="roleId"/>"><img
