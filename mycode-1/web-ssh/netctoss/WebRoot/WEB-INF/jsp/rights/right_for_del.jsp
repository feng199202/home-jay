							...
							<table cellspacing='1' cellpadding='1' width="100%" border="0"
								...
								<s:iterator value="rights" status="status">
									<tr>
										...
										<td><a
											href="${pageContext.request.contextPath}/admin/manageRoleRightAction!deleteRight?right.rightId=<s:property value="rightId"/>"
											onclick="return window.confirm('确认要删除吗?')"><img src="${pageContext.request.contextPath}/images/cross.png"/></a></td>
